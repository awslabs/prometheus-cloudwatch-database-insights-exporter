...
A Prometheus exporter that provides Aurora/RDS Performance Insights metrics with auto-discovery capabilities. Flexible instance filtering functionality will be available in an upcoming release.
